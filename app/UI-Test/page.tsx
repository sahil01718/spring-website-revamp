...
const testimonialVideos = [
  ...
  { videoId: "CSVJa2PK7M8", quote: '"Clear and actionable financial strategies."' },
...
const TestimonialCard = ({
  ...
  return (
    ...
    >
      ...
      <p className="text-center text-black text-sm font-medium break-words">{quote}</p>
    </motion.div>
  );
};
  ...
  return (
    <div className="font-sans space-y-16">
      ...
      <section className="container mx-auto px-4 max-w-screen-xl">
        <h2 className="text-3xl font-bold text-center text-[#07301E] mb-4">Who We Serve</h2>
        ...
        <Carousel>
          {professionalSolutions.concat(professionalSolutions).map((profile, index) => (
            ...
            >
              <h3 className="text-xl font-semibold text-[#07301E] mb-1">{profile.title}</h3>
              <p className="text-sm text-black font-medium mb-2">{profile.tagline}</p>
              <p className="text-black text-sm break-words">{profile.description}</p>
            </div>
          ))}
        </Carousel>
      </section>
      ...
      <section className="container mx-auto px-4 max-w-screen-xl">
        <h2 className="text-3xl font-bold text-center text-[#07301E] mb-4">Real People. Real Results.</h2>
      ...
      <section className="container mx-auto px-4 py-16 max-w-screen-xl">
        <h2 className="text-3xl font-bold text-center text-[#07301E] mb-4">Our Mission & Vision</h2>
        <p className="text-lg text-center text-black max-w-2xl mx-auto mb-10">
          ...
          We bridge the gap between you and SEBI-registered advisors, ensuring that financial planning is
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-md hover:shadow-lg transition-shadow">
            <Image
              ...
              className="w-full h-40 object-cover rounded-md mb-2"
            />
            <p className="text-center text-sm text-black font-medium">Empowered Decisions</p>
          </div>
        </div>
      ...
      {/* OUR TEAM SECTION */}
      <section className="container mx-auto px-4 py-16 max-w-screen-xl">
        <h2 className="text-3xl font-bold text-center text-[#07301E] mb-4">Our Team</h2>
        <p className="text-lg text-center text-black max-w-2xl mx-auto mb-10">
          ...
          <div className="flex space-x-4">
            {teamMembers.map((member) => (
              ...
              >
                ...
                <p className="text-center text-sm text-black">{member.designation}</p>
              </div>
            ))}
          </div>
        </div>
